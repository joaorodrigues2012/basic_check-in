let participantes = [{
    ...
    nome: "Mayk Brito", email: "mayk@gmail.com", dataInscricao: new Date(2024, 2, 23, 19, 23), dataCheckIn: null
}, {
    nome: "Ana Souza",
    email: "ana@gmail.com",
    ...
    nome: "Maria Oliveira", email: "maria@gmail.com", dataInscricao: new Date(2023, 10, 5, 19, 23), dataCheckIn: null
}, {
    nome: "Pedro Santos",
    ...
    nome: "Paula Costa", email: "paula@gmail.com", dataInscricao: new Date(2023, 6, 9, 19, 23), dataCheckIn: null
}, {
    nome: "Gabriel Almeida", email: "gabriel@gmail.com", dataInscricao: new Date(2023, 5, 10, 19, 23), dataCheckIn: null
}];
...
const criarNovoParticipante = (participante) => {
    ...
    participante.nome = decodeURIComponent(participante.nome);
